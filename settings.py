...
homepage_default = u"臺北榮總COVID-19疫苗殘劑預約登記 https://www6.vghtpe.gov.tw/reg/c19vaccLine.do"
    ...
    if btn_save_act(slience_mode=True):
        ...
        if hasattr(sys, 'frozen'):
            ...
            if platform.system() == 'Darwin':
                 subprocess.Popen("./vghtpe.py", shell=True)
            if platform.system() == 'Windows':
                subprocess.Popen("vghtpe.exe", shell=True)
        else:
            subprocess.Popen("python vghtpe.py", shell=True)
